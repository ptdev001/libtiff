 ...
 */
   ...
   */
    ...
    #define TIFF_MSC_DEPRECATED \
      __declspec(deprecated("libtiff type deprecated; please use corresponding C99 stdint.h type"))
  #else
    #define TIFF_MSC_DEPRECATED
  #endif
...
[Adobe TIFF technote] */
  ...
  #define TIFFTAG_IMAGESOURCEDATA                                                                                    \
    37724 /* http://justsolve.archiveteam.org/wiki/PSD, http://www.adobe.com/devnet-apps/photoshop/fileformatashtml/ \
           */
...
of the sensor */
  ...
  #define TIFFTAG_RPCCOEFFICIENT \
    50844 /* Define by GDAL for geospatial georeferencing through RPC: http://geotiff.maptools.org/rpc_prop.html */
...
data generation */
  ...
  #define EXIFTAG_SENSITIVITYTYPE                                                                                     \
    34864 /* The SensitivityType tag indicates which one of the parameters of ISO12232 is the PhotographicSensitivity \
             tag. */
  #define EXIFTAG_STANDARDOUTPUTSENSITIVITY                                                                      \
    34865 /* This tag indicates the standard output sensitivity value of a camera or input device defined in ISO \
             12232. */
  ...
  #define EXIFTAG_ACCELERATION                                                                                     \
    37892 /* Acceleration (a scalar regardless of direction) as the ambient situation at the shot in units of mGal \
             (10-5 m/s^2) */
  #define EXIFTAG_CAMERAELEVATIONANGLE                                                                         \
    37893 /* Elevation/depression. angle of the orientation of the camera(imaging optical axis) as the ambient \
             situation at the shot in degree from -180deg to +180deg. */
  ...
  #define EXIFTAG_LENSSPECIFICATION                                                                                    \
    42034 /* minimum focal length (in mm), maximum focal length (in mm), minimum F number in the minimum focal length, \
  ...
  #define GPSTAG_DATESTAMP \
    29 /* 	A character string recording date and time information relative to UTC (Coordinated Universal Time).	 */
