...
typedef struct
{
  ...
  uint32_t td_stripoffsetbyteallocsize; /* number of elements currently allocated for td_stripoffset/td_stripbytecount.
  ...
  uint16* td_grayresponsecurve; /* XXX GOM */
  ...
  #define FIELD_GRAYRESPONSECURVE 67 /* XXX GOM */
  /*
